...
class AppState extends ChangeNotifier {
  ...
  // 历史曲线页面状态
  DateTime furnaceEnergyStart = DateTime.now().subtract(const Duration(hours: 24));
  DateTime furnaceEnergyEnd = DateTime.now();
  DateTime furnaceTempStart = DateTime.now().subtract(const Duration(hours: 24));
  ...
  DateTime fanVibrationStart = DateTime.now().subtract(const Duration(hours: 24));
  ...
  DateTime coolingWaterQueryStart = DateTime.now().subtract(const Duration(hours: 24));
  ...
  DateTime fanEnergyQueryStart = DateTime.now().subtract(const Duration(hours: 24));
  DateTime fanEnergyQueryEnd = DateTime.now();

  // 报警记录页面状态
  DateTime furnaceSkinStart = DateTime.now().subtract(const Duration(hours: 24));
  DateTime furnaceSkinEnd = DateTime.now();
  DateTime coolingWaterStart = DateTime.now().subtract(const Duration(hours: 24));
  DateTime coolingWaterEnd = DateTime.now();
  DateTime preFilterAlarmStart = DateTime.now().subtract(const Duration(hours: 24));
  DateTime preFilterAlarmEnd = DateTime.now();
  DateTime dustInletAlarmStart = DateTime.now().subtract(const Duration(hours: 24));
  ...
  DateTime fanVibrationAlarmStart = DateTime.now().subtract(const Duration(hours: 24));
  ...
  Future<void> _loadState() async {
    try {
      ...
      furnaceEnergyStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceEnergyStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      furnaceEnergyEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceEnergyEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      furnaceTempStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceTempStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      furnaceTempEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceTempEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      preFilterStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('preFilterStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      ...
      dustInletStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('dustInletStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      ...
      fanVibrationStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanVibrationStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      fanVibrationEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanVibrationEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      ...
      coolingWaterQueryStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('coolingWaterQueryStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      coolingWaterQueryEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('coolingWaterQueryEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      pm10QueryStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('pm10QueryStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      ...
      valveQueryStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('valveQueryStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      ...
      fanEnergyQueryStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanEnergyQueryStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      fanEnergyQueryEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanEnergyQueryEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );

      // 加载报警记录页面状态
      furnaceSkinStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceSkinStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      furnaceSkinEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('furnaceSkinEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      coolingWaterStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('coolingWaterStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      coolingWaterEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('coolingWaterEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      preFilterAlarmStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('preFilterAlarmStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      preFilterAlarmEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('preFilterAlarmEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      dustInletAlarmStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('dustInletAlarmStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      dustInletAlarmEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('dustInletAlarmEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
      pm10AlarmStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('pm10AlarmStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      ...
      fanVibrationAlarmStart = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanVibrationAlarmStart') ?? DateTime.now().subtract(const Duration(hours: 24)).millisecondsSinceEpoch,
      );
      fanVibrationAlarmEnd = DateTime.fromMillisecondsSinceEpoch(
        _prefs.getInt('fanVibrationAlarmEnd') ?? DateTime.now().millisecondsSinceEpoch,
      );
  ...
  Future<void> saveDataScreenState() async {
    ...
    await _prefs.setString('valves', jsonEncode(valves.map((e) => e.toJson()).toList()));
    notifyListeners();
  }
  ...
  Future<void> saveHistoryCurveState() async {
    await _prefs.setInt('furnaceEnergyStart', furnaceEnergyStart.millisecondsSinceEpoch);
    await _prefs.setInt('furnaceEnergyEnd', furnaceEnergyEnd.millisecondsSinceEpoch);
    await _prefs.setInt('furnaceTempStart', furnaceTempStart.millisecondsSinceEpoch);
    await _prefs.setInt('furnaceTempEnd', furnaceTempEnd.millisecondsSinceEpoch);
    await _prefs.setInt('preFilterStart', preFilterStart.millisecondsSinceEpoch);
    await _prefs.setInt('preFilterEnd', preFilterEnd.millisecondsSinceEpoch);
    await _prefs.setInt('dustInletStart', dustInletStart.millisecondsSinceEpoch);
    await _prefs.setInt('dustInletEnd', dustInletEnd.millisecondsSinceEpoch);
    await _prefs.setInt('fanVibrationStart', fanVibrationStart.millisecondsSinceEpoch);
    await _prefs.setInt('fanVibrationEnd', fanVibrationEnd.millisecondsSinceEpoch);
    notifyListeners();
  }
  ...
  Future<void> saveDataQueryState() async {
    ...
    await _prefs.setInt('coolingWaterQueryStart', coolingWaterQueryStart.millisecondsSinceEpoch);
    await _prefs.setInt('coolingWaterQueryEnd', coolingWaterQueryEnd.millisecondsSinceEpoch);
    await _prefs.setInt('pm10QueryStart', pm10QueryStart.millisecondsSinceEpoch);
    await _prefs.setInt('pm10QueryEnd', pm10QueryEnd.millisecondsSinceEpoch);
    await _prefs.setInt('valveQueryStart', valveQueryStart.millisecondsSinceEpoch);
    await _prefs.setInt('valveQueryEnd', valveQueryEnd.millisecondsSinceEpoch);
    await _prefs.setInt('fanEnergyQueryStart', fanEnergyQueryStart.millisecondsSinceEpoch);
    await _prefs.setInt('fanEnergyQueryEnd', fanEnergyQueryEnd.millisecondsSinceEpoch);
    notifyListeners();
  }

  /// 保存报警记录页面状态
  Future<void> saveAlarmRecordState() async {
    await _prefs.setInt('furnaceSkinStart', furnaceSkinStart.millisecondsSinceEpoch);
    await _prefs.setInt('furnaceSkinEnd', furnaceSkinEnd.millisecondsSinceEpoch);
    await _prefs.setInt('coolingWaterStart', coolingWaterStart.millisecondsSinceEpoch);
    await _prefs.setInt('coolingWaterEnd', coolingWaterEnd.millisecondsSinceEpoch);
    await _prefs.setInt('preFilterAlarmStart', preFilterAlarmStart.millisecondsSinceEpoch);
    await _prefs.setInt('preFilterAlarmEnd', preFilterAlarmEnd.millisecondsSinceEpoch);
    await _prefs.setInt('dustInletAlarmStart', dustInletAlarmStart.millisecondsSinceEpoch);
    await _prefs.setInt('dustInletAlarmEnd', dustInletAlarmEnd.millisecondsSinceEpoch);
    await _prefs.setInt('pm10AlarmStart', pm10AlarmStart.millisecondsSinceEpoch);
    await _prefs.setInt('pm10AlarmEnd', pm10AlarmEnd.millisecondsSinceEpoch);
    await _prefs.setInt('fanVibrationAlarmStart', fanVibrationAlarmStart.millisecondsSinceEpoch);
    await _prefs.setInt('fanVibrationAlarmEnd', fanVibrationAlarmEnd.millisecondsSinceEpoch);
    notifyListeners();
  }
